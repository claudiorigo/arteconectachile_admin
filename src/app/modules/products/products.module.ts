...
import { DeleteProductImageComponent } from './edit-new-product/delete-product-image/delete-product-image.component';
...
@NgModule({
  declarations: [ProductsComponent, AddNewProductComponent, ListProductsComponent, EditNewProductComponent, DeleteNewProductComponent, DeleteProductImageComponent, DeleteItemInventarioComponent, EditItemInventarioComponent, DeleteSubItemInventarioComponent, EditSubItemInventarioComponent],
  imports: [
    CommonModule,
